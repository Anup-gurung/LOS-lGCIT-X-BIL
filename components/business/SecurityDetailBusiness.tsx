    ...
    if (guarantor.lookupStatus === "found" && guarantor.fetchedCustomerData) {
      ...
      if (ndiRaw) {
        try {
          ...
          if (ndiData && Object.keys(ndiData).length > 0) {
            ...
            const remapped: any = {
              ...
              salutation: ndiData.salutation
                ...
                : "",
              // Identification — NDI is the authoritative source
              ...
              // Address — labels will be resolved below
            ...
            // Fallback to user-typed values if NDI didn't provide identification
            const guarantor = guarantors[index];
            ...
            // Clear the session key to prevent accidental reuse
          ...
          console.error("Failed to parse ndiCoBorrowerUserData from session (SecurityDetailBusiness)", e);
        }
      }
