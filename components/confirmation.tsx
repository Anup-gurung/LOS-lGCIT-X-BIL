    ...
    >
      ...
      <AccordionSection title="Co-Borrower Details" defaultOpen>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
          ...
          <Field
            label="Applicant Name"
            value={coBorrowerData.applicantName}
            capitalizeFirst={true}
          />
          <Field
            label="Nationality"
        ...
        {coBorrowerData.maritalStatus === "married" && (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
              ...
              <Field
                label="Spouse Name"
                value={coBorrowerData.spouseName}
                capitalizeFirst={true}
              />
              <Field label="Spouse CID" value={coBorrowerData.spouseCid} />
              <Field
                label="Spouse Contact"
                value={coBorrowerData.spouseContact}
              />
            </div>
          </>
        )}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
          <Field
            label="Family Tree Documents"
            value={
              coBorrowerData.familyTreeDocs
                ? coBorrowerData.familyTreeDocs.name
                : ""
            }
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
          ...
          <Field
            label="Passport Photo"
            value={
              coBorrowerData.passportPhotoFile
                ? coBorrowerData.passportPhotoFile.name
                : ""
            }
          />
        </div>
        ...
        <div className="mt-6 sm:mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
            <Field
              label="Permanent Address Proof"
              value={
                coBorrowerData.permAddressProofFile
                  ? coBorrowerData.permAddressProofFile.name
                  : ""
              }
            />
          </div>
        ...
        <div className="mt-6 sm:mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
            <Field
              label="Current Address Proof"
              value={
                coBorrowerData.currAddressProofFile
                  ? coBorrowerData.currAddressProofFile.name
                  : ""
              }
            />
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
            <Field
              label="BIL Related"
              value={coBorrowerData.bilRelated}
              capitalizeFirst={true}
            />
          </div>
        </div>
          ...
          {coBorrowerData.employmentStatus === "employed" && (
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
                <Field
                  label="Employee ID"
                  value={coBorrowerData.employeeId || "No value"}
                />
                <Field
                  label="Occupation"
                ...
                <Field
                  label="Grade"
                  value={coBorrowerData.grade || "No value"}
                />
            ...
            return selectedIncome.map((item) => (
              ...
              >
                ...
                <Field
                  ...
                  value={
                    repaymentData?.incomeData?.repaymentGuarantor?.incomeData?.[
                      item.proofKey
